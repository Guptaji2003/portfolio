...
const Hero = () => {
  ...
  const projectsData = [
    ...
    },
    {
      id: 2, 
      title: "Quize App",
      description: "Full-stack e-commerce application with React, Node.js, and MongoDB featuring cart functionality and payment integration",
      image: project2,
    ...
    },
    {
      ...
      description: "A collaborative task management tool built with React and Firebase, featuring real-time updates and team workspaces",
      image: project3,
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
          ...
          <div className="max-w-6xl mx-auto text-center">
            <div className="relative z-10">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-[wave_8s_ease-in-out_infinite]">
                Hi, I'm <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 animate-pulse">Pulkit Gupta</span>
              </h1>
              <style jsx>{`
              @keyframes wave {
                0%, 100% {
            ...
            `}</style>
              ...
              <div className="flex gap-4 justify-center">
                <a href="#projects"><button className="px-8 py-3 bg-gradient-to-r from-pink-500 to-violet-500 rounded-full hover:scale-105 transition-transform">
                  View Projects
                </button></a>
                <a href="#contact"><button className="px-8 py-3 border-2 border-pink-500 rounded-full hover:bg-pink-500/20 transition-colors">
                  Contact Me
                </button></a>
              </div>
            </div>
          ...
          <div className="relative w-full">
            <div className="flex space-x-8 animate-scroll-left">
              <div className="flex space-x-8 min-w-full">
                <svg className="h-8 w-auto text-gray-400" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-5.5-2.5l7.51-3.49L17.5 6.5 9.99 9.99 6.5 17.5zm5.5-6.6c.61 0 1.1.49 1.1 1.1s-.49 1.1-1.1 1.1-1.1-.49-1.1-1.1.49-1.1 1.1-1.1z"/>
                </svg>
                <svg className="h-8 w-auto text-gray-400" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projectsData.map((project) => (
                <div key={project.id} className="group relative overflow-hidden rounded-xl bg-gray-800/50 backdrop-blur-lg">
                  <img
                    loading="lazy"
                    src={project.image}
                    alt={project.title}
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent p-6 flex flex-col justify-end transform translate-y-full group-hover:translate-y-0 bg-gray-900 transition-transform">
                    ...
                    <div className="flex gap-4">
                     <a href={project.liveUrl} target="_blank"> <button className="px-6 py-2 bg-pink-500 rounded-full hover:bg-pink-600 transition-colors">
                        View Live
                      </button></a>

                        <a href={project.githubUrl} target="_blank"> <button className="px-6 py-2 border border-pink-500 rounded-full hover:bg-pink-500/20 transition-colors">
                          GitHub
                        </button></a>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Certificate Card 1 */}
              {
                certificatesData.map((c) => (
                  <>
                    <div /*onClick={() => handleCertificateClick(c)}*/ className="group bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 hover:bg-gray-700/50 transition-all duration-300 transform hover:-translate-y-2">
        ...
        {/* Contact Section */}
        <section id="contact" className="relative py-20 px-4 bg-gray-900/50 backdrop-blur-lg">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">
              Let's Connect
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col justify-center space-y-8">
                ...
                <div className="flex space-x-4 mt-8">
                  <a href="#" className="w-12 h-12 rounded-full bg-gray-800/50 flex items-center justify-center hover:bg-pink-500/20 transition-colors">
                  ...
                  <a href="www.linkedin.com/in/pulkit-gupta-7300b6322" className="w-12 h-12 rounded-full bg-gray-800/50 flex items-center justify-center hover:bg-pink-500/20 transition-colors">
                    <svg className="w-6 h-6 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
